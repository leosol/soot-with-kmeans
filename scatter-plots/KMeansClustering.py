...
class KMeansClustering:
    ...
    def scatter_plot_without_clsrs(self, labels, title, xLabel, yLabel):
...
def vw_expected_time_vs_permissions():
    connection_object = sqlite3.connect('..\\example-analysis\\example-analysis.db')
    cursor = connection_object.cursor()
    sqlite_select_Query = """select * from vw_expected_time_vs_permissions"""
    ...
    kmc.create_clusters()
    kmc.scatter_plot_without_clsrs(labels, "Qtd. Permissions vs Expected Time to get Location", "Qtd. Permissions", "Expected Time (s)")
    print(kmc.compute_clusters())
    kmc.scatter_plot_with_clusters(labels, "Qtd. Permissions vs Expected Time to get Location", "Qtd. Permissions", "Expected Time (s)")
...
def test_examples():
    ...
    print(kmc.clusters)
    print(kmc.compute_clusters())
    kmc.scatter_plot_without_clsrs(["A", "B", "C", "D", "E", "F", "G", "H"], "Kmeans Example", "X axis", "Y Axis")
    kmc.scatter_plot_with_clusters(["A", "B", "C", "D", "E", "F", "G", "H"], "Kmeans Example", "X axis", "Y Axis")
